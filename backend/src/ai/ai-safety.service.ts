...
const ATTACK_WORDS: [string, BlockReasonType][] = [
  ...
  ['傻B', BlockReasonType.ATTACK],
  ['煞笔', BlockReasonType.ATTACK],
  ['沙雕', BlockReasonType.ATTACK],
  ['脑残', BlockReasonType.ATTACK],
  ['智障', BlockReasonType.ATTACK],
  ['弱智', BlockReasonType.ATTACK],
  ['废物', BlockReasonType.ATTACK],
  ['垃圾', BlockReasonType.ATTACK],
  ['去死', BlockReasonType.ATTACK],
  ['滚蛋', BlockReasonType.ATTACK],
  ['滚开', BlockReasonType.ATTACK],
  ...
  // 常见脏话/辱骂
  ['妈的', BlockReasonType.ATTACK],
  ['他妈', BlockReasonType.ATTACK],
  ['tmd', BlockReasonType.ATTACK],
  ['卧槽', BlockReasonType.ATTACK],
  ['我操', BlockReasonType.ATTACK],
  ['我草', BlockReasonType.ATTACK],
  ['艹', BlockReasonType.ATTACK],
  ['操你', BlockReasonType.ATTACK],
  ['草你', BlockReasonType.ATTACK],
  ['日你', BlockReasonType.ATTACK],
  ['干你', BlockReasonType.ATTACK],
  ['你妈', BlockReasonType.ATTACK],
  ['尼玛', BlockReasonType.ATTACK],
  ['你🐎', BlockReasonType.ATTACK],
  ['草泥马', BlockReasonType.ATTACK],
  ['草你妈', BlockReasonType.ATTACK],
  ['操你妈', BlockReasonType.ATTACK],
  ['cnm', BlockReasonType.ATTACK],
  ['nmsl', BlockReasonType.ATTACK],
  ['你妈死', BlockReasonType.ATTACK],
  ['狗东西', BlockReasonType.ATTACK],
  ['狗娘养', BlockReasonType.ATTACK],
  ['贱人', BlockReasonType.ATTACK],
  ['贱货', BlockReasonType.ATTACK],
  ['婊子', BlockReasonType.ATTACK],
  ['骚货', BlockReasonType.ATTACK],
  ['王八蛋', BlockReasonType.ATTACK],
  ['混蛋', BlockReasonType.ATTACK],
  ['畜生', BlockReasonType.ATTACK],
  ['杂种', BlockReasonType.ATTACK],
  ['狗屎', BlockReasonType.ATTACK],
  ['放屁', BlockReasonType.ATTACK],
  ['滚犊子', BlockReasonType.ATTACK],
  ['傻缺', BlockReasonType.ATTACK],
  ['蠢货', BlockReasonType.ATTACK],
  ['神经病', BlockReasonType.ATTACK],
  ['fuck', BlockReasonType.ATTACK],
  ['shit', BlockReasonType.ATTACK],
  ['bitch', BlockReasonType.ATTACK],
  ['fuckyou', BlockReasonType.ATTACK],
]
