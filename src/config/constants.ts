...
export const ROUTE = {
  ...
  BASIC_INFO: '/pages/basic-info/index',
  VIP: '/pages/vip/index',
  ...
  PRIVACY_SETTINGS: '/pages/privacy-settings/index',
  REALNAME_AUTH: '/pages/real-name-auth/index',
  REALNAME_AUTH_INPUT: '/pages/realname-auth-input/index',

  // 我的
  MY_FOLLOWS: '/pages/my-follows/index',
  MY_VISITORS: '/pages/my-visitors/index',
  CIRCLE_POSTS: '/pages/circle-posts/index',
  CIRCLE_PUBLISH: '/pages/circle-publish/index',
  MESSAGE_LIST: '/pages/message-list/index',
  PAY_RESULT: '/pages/pay-result/index',
  SYSTEM_MESSAGES: '/pages/system-messages/index',
  SINGLE_PROMISE: '/pages/single-promise/index',

  // AI
  AI_QUIZ: '/pages/ai-quiz/ai-quiz',
